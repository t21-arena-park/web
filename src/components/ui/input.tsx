...
const input = tv({
  ...
  variants: {
    variant: {
      ...
      import: {
        root: "group box-border flex items-center justify-center gap-2 rounded-md border border-dashed border-2 px-4 px-3 h-32 focus-within:outline-none ring-offset-lime-400 placeholder:text-slate-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-transparent focus-within:ring-offset-2",
        control:
          "border-none text-slate-100 text-sm font-normal transition-colors placeholder:text-slate-400",
      },
    },
  },
  defaultVariants: {
